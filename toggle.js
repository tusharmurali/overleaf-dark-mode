...
.ace_editor, .pdf-viewer, .pdfjs-controls, .project-list-main, .project-list-main .fa-circle, .site-footer, #review-panel, .modal-content, #left-menu, .history-entry-day, .loading-panel {
    filter: invert(100%);
